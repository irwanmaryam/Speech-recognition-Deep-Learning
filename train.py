...
###################################################################
    ...
    tf.logging.info('Step number #%d: learning rate %f, model accuracy %.1f%%, model cross entropy %f' %
...
#############################################################
      ...
      tf.logging.info('Step number %d: Validation Model accuracy = %.1f%% (N=%d)' %
...
############################################################
  ...
  for i in xrange(0, set_size, FLAGS.batch_size):
    ...
    if total_conf_matrix is None:
      ...
      total_conf_matrix += conf_matrix
  tf.logging.info('Confusion Matrix:\n %s' % (total_conf_matrix))
  tf.logging.info('Final model accuracy accuracy = %.1f%% (N=%d)' % (total_accuracy * 100,
                                                           set_size))
